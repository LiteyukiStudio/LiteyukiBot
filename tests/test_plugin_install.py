...
from liteyukibot.plugin_store import PluginIndex, PluginStoreError, RuntimeGenerationStore
...
def _index(digest: str, *, dependency_cycle: bool = False) -> PluginIndex:
...
def test_installer_resolves_dependencies_and_activates_only_after_materialization(
    ...
    assert commands[1][-2:] == ["runtime-v6==1.2.3", "requests>=2"]
