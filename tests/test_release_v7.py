...
@pytest.mark.parametrize(
    ...
    [
        ("root", "v7.0.0a2"),
        ("permissions", "permissions-v0.3.0a1"),
        ...
        ("runtime-nonebot", "runtime-nonebot-v7.0.0a2"),
        ("runtime-adapter", "runtime-adapter-v7.0.0a2"),
        ...
        ("runtime-astrbot", "runtime-astrbot-v7.0.0a2"),
        ("runtime-mofox", "runtime-mofox-v0.1.0a8"),
        ("webui", "webui-v7.0.0a2"),
        ("ipc-native", "ipc-native-v7.0.0a2"),
    ],
)
