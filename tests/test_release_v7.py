...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("runtime-nonebot", "runtime-nonebot-v7.0.0a3"),
        ("runtime-adapter", "runtime-adapter-v7.0.0a3"),
        ...
        ("runtime-astrbot", "runtime-astrbot-v7.0.0a3"),
        ("runtime-mofox", "runtime-mofox-v0.1.0a8"),
        ("webui", "webui-v7.0.0a3"),
        ("ipc-native", "ipc-native-v7.0.0a3"),
    ],
)
