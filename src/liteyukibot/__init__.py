...
_LAZY_EXPORTS = {
    ...
    "WEBUI_API_VERSION": (".plugins", "WEBUI_API_VERSION"),
    "WEBUI_SCHEMA_DRAFT_2020_12": (".plugins", "WEBUI_SCHEMA_DRAFT_2020_12"),
    "WebUiComponent": (".plugins", "WebUiComponent"),
    "WebUiContributionManifest": (".plugins", "WebUiContributionManifest"),
    "WebUiDiagnostic": (".plugins", "WebUiDiagnostic"),
    "WebUiProvider": (".plugins", "WebUiProvider"),
    "WebUiSnapshot": (".plugins", "WebUiSnapshot"),
    "WebUiSnapshotState": (".plugins", "WebUiSnapshotState"),
    "WebUiSurfaceManifest": (".plugins", "WebUiSurfaceManifest"),
