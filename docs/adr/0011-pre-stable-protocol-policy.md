...
The current local runtime IPC version is v4. The repository still tests v1,
v2, and v3 peers because that code exists and remains inexpensive to exercise,
but this must not be confused with a pre-stable compatibility promise.
...
- v3 remains the direct-edit baseline for small and medium changes;
